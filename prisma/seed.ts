...
async function main() {
  ...
  const permissions = [
    ...
    {
      name: "REKAM_READ_OWN",
      description: "Membaca rekam medis milik sendiri",
    },
    { name: "REKAM_UPDATE", description: "Mengubah rekam medis" },
    {
      name: "JADWAL_MANAGE",
      description: "Membuat dan mengubah jadwal praktik",
    },
    ...
    { name: "USER_MANAGE", description: "Mengelola akun pengguna" },
    { name: "ROLE_ASSIGN", description: "Menetapkan role ke pengguna" },
  ];
  ...
  const roles = [
    {
      name: "SUPERADMIN",
      description: "Administrator penuh, akses semua fitur",
    },
    {
      name: "DOKTER",
      description: "Dokter praktik, akses rekam medis dan jadwal",
    },
    { name: "PERAWAT", description: "Perawat, akses pendaftaran dan antrian" },
    { name: "KASIR", description: "Kasir, akses pembayaran" },
    {
      name: "PASIEN",
      description: "Pasien terdaftar, akses data diri sendiri",
    },
  ];
